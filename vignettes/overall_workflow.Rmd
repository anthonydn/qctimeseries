...
```r
# Load the example QC object shipped with qctimeseries
load(system.file("extdata", "ibutton_example_qc.RData", package = "qctimeseries"))

# Quick look at progress, then open the windowed app
qc_progress(ibutton_example_qc, hide_complete = FALSE)

# Set y_col to a variable present in the object; adjust time_col if needed
ibutton_example_qc <- qc_window_app(ibutton_example_qc,
  y_col = "temp", time_col = "DateTime")
```
